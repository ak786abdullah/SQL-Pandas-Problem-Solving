-- Problem 12: Number of Transactions Per Product
...
VALUES(1, 'strawberry', 'produce', 'lb', 3.28, 1.77, 13),(2, 'apple_fuji', 'produce', 'lb', 1.44, 0.43, 2),(3, 'orange', 'produce', 'lb', 1.02, 0.37, 2),
...
FROM
	excel_sql_inventory_data inv 
    JOIN excel_sql_transaction_data trans
    ON inv.product_id = trans.product_id 
GROUP BY 
