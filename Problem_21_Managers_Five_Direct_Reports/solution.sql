-- Problem 21: Managers with at Least 5 Direct Reporting Employees
-- Find managers with at least 5 direct reporting employees.
...
employee_title VARCHAR(50),department VARCHAR(50),salary INT,target INT,bonus INT,email VARCHAR(100),city VARCHAR(50),address VARCHAR(255),manager_id INT);
