...
FROM 
    ...
    LEFT JOIN 
		innerwear_macys_com m ON a.product_name=m.product_name AND a.mrp = m.mrp
    LEFT JOIN 
		innerwear_topshop_com t ON a.product_name=t.product_name AND a.mrp = t.mrp
WHERE 
	m.product_name is null AND t.product_name is null
ORDER BY 
	a.product_name;