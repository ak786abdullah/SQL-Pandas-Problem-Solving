...
![Problems](https://img.shields.io/badge/Problems_Solved-100+-success.svg)
![Platforms](https://img.shields.io/badge/Platforms-LeetCode%20%7C%20HackerRank%20%7C%20GFG-orange.svg)

A structured collection of **100+ data problems** sourced from LeetCode, HackerRank, and GeeksForGeeks — each solved in both **SQL** and **Python (Pandas)**. Built to sharpen real-world data analysis and database querying skills.
